        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_rate:
                    ...
                    FragmentTransaction fragmentRateTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentRateTransaction.replace(R.id.content, rateFragment);
                    fragmentRateTransaction.commit();
                    return true;
