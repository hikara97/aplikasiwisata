package com.example.obi.proyekakhir._sliders;
...
import com.example.obi.proyekakhir.R;
...
public class FragmentSlider extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Uri uri = Uri.parse("android.resource://com.example.obi.proyekakhir/drawable/"+imageUrls);
